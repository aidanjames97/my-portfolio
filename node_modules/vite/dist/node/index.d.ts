...
import * as Rollup from "../../types/internal/rollupTypeCompat.mjs";
import { parseAst, parseAstAsync } from "rolldown/parseAst";
import { TransformOptions as rolldown_experimental_TransformOptions, TransformResult as rolldown_experimental_TransformResult, esmExternalRequirePlugin } from "rolldown/experimental";
...
import { FetchFunction, FetchFunctionOptions, FetchResult, FetchResult as moduleRunner_FetchResult, ModuleEvaluator, ModuleRunner, ModuleRunnerHmr, ModuleRunnerOptions } from "rolldown-vite/module-runner";
import { DepsOptimizerEsbuildOptions, EsbuildTarget, EsbuildTransformOptions, EsbuildTransformOptions as esbuildOptions_EsbuildTransformOptions, EsbuildTransformResult } from "../../types/internal/esbuildOptions.js";
import { SecureContextOptions } from "node:tls";
import { URL as url_URL } from "node:url";
import { ZlibOptions } from "node:zlib";
import { ChunkMetadata, CustomPluginOptionsVite } from "../../types/metadata.mjs";
 ...
 */
interface Plugin$1<A = any> extends Rolldown.Plugin<A> {
  /**
...
type PluginOption = Thenable<Plugin$1 | {
  name: string;
...
declare function transformWithEsbuild(code: string, filename: string, options?: esbuildOptions_EsbuildTransformOptions, inMap?: object, config?: ResolvedConfig, watcher?: FSWatcher, ): Promise<ESBuildTransformResult>;
//#endregion
